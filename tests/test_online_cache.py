...
def test_doc_initial_update_works():
    ...
    assert online_cache.get_stored_result(vid) is value
...
def test_doc_updating_none_works():
    ...
    assert online_cache.get_stored_result(vid) is None
